...
public class AccommodationWithReviewsDTO {
    ...
    @JsonIgnore
    private List<RoomTypePriceDTO> roomTypePrices;  // RoomTypePrice 정보 추가

    // 기본 생성자
    public AccommodationWithReviewsDTO() {}

    // AccommodationDTO, ReviewDTO, RoomTypePriceDTO, isInWishlist를 모두 포함하는 생성자
    public AccommodationWithReviewsDTO(AccommodationDTO accommodation, List<ReviewDTO> reviews, List<RoomTypePriceDTO> roomTypePrices) {
