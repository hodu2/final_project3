...
public class AccommodationDTO {
    ...
    private List<RoomTypePriceDTO> roomTypePrices; // RoomTypePriceDTO 리스트 추가
    ...
    public AccommodationDTO(Accommodation accommodation) {
        ...
        this.roomTypePrices = accommodation.getRoomTypePrices() != null
                ...
                .map(RoomTypePriceDTO::new) // RoomTypePriceDTO 변환 생성자 호출
                .collect(Collectors.toList())
                : null;
    }
    ...
    public AccommodationDTO(Integer accomId, String accomName, String type, String description, 
                            ...
                            List<String> images, List<ReviewDTO> reviews, List<RoomTypePriceDTO> roomTypePrices) {
